...
class Decoder(nn.Module):
    ...
    def __init__(self, eprojs, odim, dtype, dlayers, dunits, sos, eos, att, verbose=0,
                 char_list=None, sampling_probability=0.0, dropout=0.0, context_residual=False, 
                 num_encs=1):
    ...
    def _sample_from_previous_output(self, prediction):
        ...
        z_out = self.output_activation(self.output(prediction))
        return z_out
...
def decoder_for(args, odim, sos, eos, att):
    return Decoder(args.eprojs, odim, args.dtype, args.dlayers, args.dunits, sos, eos, att, args.verbose,
                   args.char_list, args.sampling_probability, args.decoder_dropout,

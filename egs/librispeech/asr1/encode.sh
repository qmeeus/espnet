...
jsonfile=${1:-dump/fluent/deltafalse/data.fluent.json}
recog_model=${2:-exp/train_960_pytorch_sti_transformer_lr10.0_ag8_p.5_specaug/results/model.val5.avg.best}

...
# hybrid_model=exp/train_hybrid_mono/transformer_12_6_2048_512_8_do.1/dec-only/results/model.loss.best
...
w2v_train.py \
  --v1 \
  --config conf/train/transformer_12_6_2048_512_8_a.1e-5_do.1.yaml \
  --ngpu 1 \
  --backend pytorch \

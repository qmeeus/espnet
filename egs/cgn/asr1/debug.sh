...
w2v_train.py --v1 --config conf/train/transformer_12_6_2048_512_8_do.1.yaml --ngpu 1 --backend pytorch --outdir exp/train_bert_dutch_mono/transformer_12_6_2048_512_8_do.1/dec-only/results --debugmode 1 --ctc_type builtin --debugdir exp/train_bert_dutch_mono/transformer_12_6_2048_512_8_do.1/dec-only --minibatches 0 --verbose 1 --resume --dict none --train-json dump/CGN_train/deltafalse/data_vectors_bert_dutch.mono.json --valid-json dump/CGN_valid/deltafalse/data_vectors_bert_dutch.mono.json --enc-init exp/train_unigram_5000_mono/transformer_12_6_2048_512_8_a.4_do.1/train/results/model.loss.best --freeze-encoder -1 --model-class espnet.nets.pytorch_backend.e2e_xlmr_transformer:E2E
